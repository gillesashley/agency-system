        ...
        <div class="p-4 mt-14 mb-14">
            ...
            <div class="flex flex-wrap -mx-3">
                <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/2">
                    <div
                        class="relative flex flex-col py-10 min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p
                                            class="mb-0 font-sans font-semibold leading-normal uppercase text-gray-900 dark:opacity-60 text-lg">
                                            Total Jobs</p>
                                        <h5 class="mb-2 font-bold text-gray-900 text-4xl">+{{ $jobCount }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p
                                            class="mb-0 font-sans font-semibold leading-normal uppercase text-gray-900 dark:opacity-60 text-lg">
                                            Total Applicants</p>
                                        <h5 class="mb-2 font-bold text-gray-900 text-4xl">+{{ $applicantCount }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
